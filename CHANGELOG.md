...
- Confidence Calculator (weighted: 0.35×GIS + 0.25×Weather + 0.20×History + 0.20×Predictions)
...
- Report tab: PDF/JSON/CSV download buttons with configuration options
...
- Mock data system for 5 villages × 5 years (no API keys required)
