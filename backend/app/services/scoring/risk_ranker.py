...
def rank_risks(score: VillageHealthScore) -> List[Dict[str, Any]]:
    ...
    components: List[Dict[str, Any]] = [
        {"component": "Water Security", "score": score.water.score, "explanation": score.water.explanation},
        {"component": "Vegetation Health", "score": score.vegetation.score, "explanation": score.vegetation.explanation},
        {"component": "Climate Stability", "score": score.climate.score, "explanation": score.climate.explanation},
        {"component": "Flood Preparedness", "score": score.flood.score, "explanation": score.flood.explanation},
        {"component": "Land Sustainability", "score": score.land.score, "explanation": score.land.explanation}
    ]
